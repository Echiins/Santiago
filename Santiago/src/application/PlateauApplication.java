...
public class PlateauApplication extends Application {
    ...
    public VBox tuilesEtJr(){ //partieCommune
		...
		//Cr�ation de boutons radio permettant de choisir une tuile
        ...
        tuile1.setSelected(true);//le piano est l'instrument s�lectionn� par d�faut
    ...
    public AnchorPane ficheJr(){
    	...
    	HBox hbTr1 = new HBox();
    	HBox hbTr2 = new HBox();
    	VBox vbTr = new VBox(); // contiendra les diff�rentes HBox des travailleurs
	...
	public void start(Stage primaryStage) throws IOException {
		...
		//titre
	     ...
	     //insertion du plateau et de la fiche joueur et partie commune au stage !
			...
			vbCommun.setPadding(new Insets(5,5,5,5)); // ARR�TE LA !!!!!!
